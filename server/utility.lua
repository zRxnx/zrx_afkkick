...
local resourceName = 'zrx_afkkick'
...
AddEventHandler('onResourceStart', function(res)
    ...
    while continueCheck do
        PerformHttpRequest('https://github.com/zRxnx/zrx_afkkick/releases/latest', CheckVersion, 'GET')
        Wait(3600000)
    end
end)
...
GetRepoInformations = function()
    ...
    PerformHttpRequest('https://api.github.com/repos/zRxnx/zrx_afkkick/releases/latest', function(err, response, headers)
        if err == 200 then
            ...
            repoURL = 'https://github.com/zRxnx/zrx_afkkick'
        end
    end, 'GET')
